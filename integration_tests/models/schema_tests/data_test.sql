...
select
    ...
    cast(1 as {{ dbt.type_float() }}) as col_numeric_a,
    cast(0 as {{ dbt.type_float() }}) as col_numeric_b,
    'b' as col_string_a,
    'ab' as col_string_b,
    null as col_null,
    null as col_null_2
...
select
    ...
    cast(0.5 as {{ dbt.type_float() }}) as col_numeric_a,
    cast(0.5 as {{ dbt.type_float() }}) as col_numeric_b,
    'c' as col_string_a,
    'abc' as col_string_b,
    null as col_null,
    null as col_null_2
